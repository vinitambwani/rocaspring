...
public class SubscriptionDBResourceService {
	...
	@RequestMapping(value = "/uploadFile", method = { RequestMethod.POST })
   	public UploadFileResponse uploadFile(@RequestParam ("file") MultipartFile file,@RequestParam ("bean")String reqBean) throws IOException {
		...
		SubscriptionDocDetails uploadFile = subscriptionDao.saveFile(dataToSave);
		 ...
		 return new UploadFileResponse(uploadFile.getDocName(), fileDownloadUri, uploadFile.getDocExtention(), uploadFile.getDocDataSize());
	}
